...
std::complex<double> inline GF_far(const double p1x, const double p1y,
    const double p2x, const double p2y,
    const double nx, const double ny,
    const double coupling_parameter, std::complex<double> wavenumber, double norm_diff) {
    ...
    const double coupling_parameter, std::complex<double> wavenumber)
{
    ...
    if (norm_diff < 1e-14) {
        ...
        solution = GF_far<Formulation>(p1x, p1y, p2x, p2y, nx, ny, coupling_parameter, wavenumber, normdiff);
...
// Version for potentially close evaluations done in the precomputations
// template<FormulationType Formulation>
// std::complex<double> inline GF_close(const double p1x, const double p1y,
//     const double p2x, const double p2y,
//     const double nx, const double ny,
//     const double coupling_parameter, std::complex<double> wavenumber, double norm_diff,
//     double t1, double t2) {
